...
st.markdown("""<style>#MainMenu,footer,header,button[kind="toolbar"]{display:none;} div.stButton>button{background-color:#2563EB;color:white;font-size:18px;font-weight:bold;border-radius:10px;height:3em;width:100%;border:none;} html,body,.stApp{overflow:hidden;height:100vh;}</style>""", unsafe_allow_html=True)
